<?php
/**
 * @package       Wanguba.Plugin
 * @subpackage    folder.plg_mpesa
 * @copyright     Copyright (C) 2022 Wanguba.com, Inc. All rights reserved.
 ...
 * @subpackage   Folder.mpesa
 * @since        1.5
 */
class plgFolderMpesa extends JPlugin
{
    /**
     * Self instance
     *
    ...
    /**
     * Mpesa after display title method
     *
    ...
    /**
     * Mpesa before display content method
     *
     * Method is called by the view and the results are imploded and displayed in a placeholder
     *
     * @param    string        The context for the content passed to the plugin.
    ...
    /**
     * Mpesa after display content method
     *
     * Method is called by the view and the results are imploded and displayed in a placeholder
     *
     * @param    string        The context for the content passed to the plugin.
    ...
    /**
     * Mpesa before save content method
     *
    ...
    /**
     * Mpesa after save content method
